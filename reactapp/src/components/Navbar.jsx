    ...
    <div className="navbar bg-base-100 shadow-lg sticky top-0 z-50 transition-all duration-300">
      <div className="navbar-start">
        ...
        <div className="dropdown">
          ...
          <ul tabIndex={0} className="menu menu-sm dropdown-content mt-3 z-[1] p-2 shadow bg-base-100 rounded-box w-52">
            <li><Link to="/" className="text-base hover:text-primary">Home</Link></li>
            <li><Link to="/programs" className="text-base hover:text-primary">Programs</Link></li>
            {user && (
              <li><Link to="/dashboard" className="text-base hover:text-primary">Dashboard</Link></li>
            )}
          </ul>
        </div>
        ...
        <Link to="/" className="btn btn-ghost normal-case text-xl font-bold">
          <span className="text-primary">Admit</span>Flow
        </Link>
      </div>
      ...
      <div className="navbar-center hidden lg:flex">
        <ul className="menu menu-horizontal px-1 gap-2">
          ...
          <li><Link to="/programs" className="text-base hover:text-primary transition-colors">Programs</Link></li>
          {user && (
            <li><Link to="/dashboard" className="text-base hover:text-primary transition-colors">Dashboard</Link></li>
          )}
        </ul>
      </div>
